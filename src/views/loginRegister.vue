		...
		<div class="contain">
			<div class="big-box" :class="{active:isLogin}">
				<div class="big-contain" v-if="isLogin">
					...
					<div class="bform">
						<input type="text" placeholder="账号" v-model="form.useremail">
						<span class="errTips" v-if="countError">* 账号填写错误 *</span>
						<input type="password" placeholder="密码" v-model="form.userpwd">
						<span class="errTips" v-if="countError">* 密码填写错误 *</span>
					</div>
			...
			<div class="small-box" :class="{active:isLogin}">
				<div class="small-contain" v-if="isLogin">
					...
					<p class="scontent">开始注册，和我们一起前进</p>
					<img src="./img/公众号.jpg" style="height: 80px;width: 80px;border-radius: 5px; margin-bottom:20px" alt="">
					<button class="sbutton" @click="changeType">注册</button>
				</div>
				<div class="small-contain" v-else>
					<div class="stitle">欢迎回来!</div>
					<p class="scontent">与我们保持联系，请登录你的账户</p>
					<img src="./img/公众号.jpg" style="height: 80px;width: 80px;border-radius: 5px; margin-bottom:20px" alt="欢迎关注公众号" title="欢迎关注公众号">
